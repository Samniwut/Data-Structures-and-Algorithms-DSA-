...
{
    int i;
    srand((unsigned int)time(NULL)); //for difference random number in rand()
    for (i=1;i<=N;i++)
...
void SelectionSort(int N)
{
    ...
    printf("---------------------------------------------------------------------\n");
    for(i=1;i<=N-1;i++) //FIXED: loop only needs to go to N-1 (last element is
                         //already in place once the first N-1 are sorted)
    {
